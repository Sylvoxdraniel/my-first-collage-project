      ...
      <Modal isOpen={deleteModal.show} onClose={() => setDeleteModal({ show: false, faculty: null })} title="Delete Faculty" size="sm">
        <div className="space-y-4">
          <p className="text-dark-300">
            Are you sure you want to delete <span className="text-white font-semibold">{deleteModal.faculty?.name}</span>?
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-accent-500 to-primary-500 flex items-center justify-center text-white text-2xl font-bold">
                {viewModal.faculty.name?.charAt(0)?.toUpperCase()}
              </div>
              <div>
                <h3 className="text-xl font-bold text-white">{viewModal.faculty.name}</h3>
                <p className="text-dark-400">{viewModal.faculty.email}</p>
              </div>
            </div>
