  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 bg-white border border-slate-200 p-4 rounded-2xl shadow-sm h-fit space-y-1">
          {Object.keys(departmentsList).map((key) => (
            <button
              ...
              className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold transition-all capitalize ${
                activeDept === key
        ...
        {/* Content Box */}
        <div className="lg:col-span-3 bg-white border border-slate-200 p-8 rounded-3xl shadow-sm min-h-[500px] space-y-8">
