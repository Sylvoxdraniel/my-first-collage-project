  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        {/* Content Box */}
        <div className="lg:col-span-3 bg-white border border-slate-200 p-8 rounded-3xl shadow-sm min-h-[500px]">
                ...
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                    ...
                    <div className="space-y-3">
                      <h2 className="text-2xl font-black text-slate-900">Prof. (Dr.) Dilip Kumar Kesari</h2>
                      <p className="text-xs text-slate-400 font-bold uppercase">Vice Chancellor, Magadh University</p>
                      <p className="text-sm text-slate-600 leading-relaxed italic">
                        "Welcome to Gautam Budha Mahila College. Education is not just about loading minds with facts, it is about sparking a flame of scientific inquiry. We strive to provide our students with the resource support they need to become responsible global citizens and leaders in their chosen professions."
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === 'director' && (
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                    ...
                    <div className="space-y-3">
                      <h2 className="text-2xl font-black text-slate-900">Prof. (Dr.) Seema Patel</h2>
                      <p className="text-xs text-slate-400 font-bold uppercase">Principal, Gautam Budha Mahila College</p>
                      <p className="text-sm text-slate-600 leading-relaxed italic">
                        "At Gautam Budha Mahila College, we have established a culture of academic rigor and student achievements. With a focus on research, modern laboratories, and expert guidance, our campus continues to be the top choice for students looking to excel in science and computer applications."
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === 'principal' && (
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                    ...
                    <div className="space-y-3">
                      <h2 className="text-2xl font-black text-slate-900">Dr. Sunita Sharma</h2>
                      <p className="text-xs text-slate-400 font-bold uppercase">Patron, Gautam Budha Mahila College</p>
                      <p className="text-sm text-slate-600 leading-relaxed italic">
                        "It is an honor to lead this institution. We have structured a syllabus support framework, dynamic co-curricular activities, and sports events to ensure that education is holistic, enjoyable, and creates highly employable graduates."
                      </p>
                    </div>
                  </div>
                </div>
