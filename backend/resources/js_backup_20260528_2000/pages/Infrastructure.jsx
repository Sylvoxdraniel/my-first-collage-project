...
export default function Infrastructure() {
  ...
  const item = facilities[activeItem] || facilities.classrooms;
          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-xs font-bold transition-all shrink-0 text-left lg:w-full ${
                  activeItem === tab.id
