          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              <select
                ...
                onChange={handleChange}
                className="flex-1 rounded-xl border bg-dark-800/50 text-white border-dark-600/50 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 px-4 py-2.5 text-sm transition-all"
              >
