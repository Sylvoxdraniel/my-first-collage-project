      ...
      >
        <div className="space-y-4">
          <p className="text-dark-300">
            Are you sure you want to delete <span className="text-white font-semibold">{deleteModal.student?.user?.name || deleteModal.student?.name}</span>? This action cannot be undone.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center text-white text-2xl font-bold">
                {viewModal.student.user?.name?.charAt(0)?.toUpperCase() || viewModal.student.name?.charAt(0)?.toUpperCase()}
              </div>
              <div>
                <h3 className="text-xl font-bold text-white">{viewModal.student.user?.name || viewModal.student.name}</h3>
                <p className="text-dark-400">{viewModal.student.user?.email || viewModal.student.email}</p>
              </div>
            </div>
