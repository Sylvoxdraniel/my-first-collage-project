      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button
            ...
            className="flex flex-col items-center justify-center p-4 rounded-xl bg-primary-500/10 text-primary-400 hover:bg-primary-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all gap-2 text-center group border border-primary-500/10 cursor-pointer"
          >
            <HiOutlineUserAdd className="w-7 h-7 group-hover:scale-110 transition-transform" />
            <span className="text-sm font-medium">Add Student</span>
          </button>
          <button
            onClick={() => navigate('/faculty?action=add')}
            className="flex flex-col items-center justify-center p-4 rounded-xl bg-accent-500/10 text-accent-400 hover:bg-accent-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all gap-2 text-center group border border-accent-500/10 cursor-pointer"
          >
            <HiOutlineAcademicCap className="w-7 h-7 group-hover:scale-110 transition-transform" />
            <span className="text-sm font-medium">Add Faculty</span>
          </button>
          <button
            onClick={() => navigate('/courses-manager?action=add')}
            className="flex flex-col items-center justify-center p-4 rounded-xl bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all gap-2 text-center group border border-blue-500/10 cursor-pointer"
          >
            <HiOutlineBookOpen className="w-7 h-7 group-hover:scale-110 transition-transform" />
            <span className="text-sm font-medium">Add Course</span>
          </button>
          <button
            onClick={() => navigate('/departments?action=add')}
            className="flex flex-col items-center justify-center p-4 rounded-xl bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all gap-2 text-center group border border-amber-500/10 cursor-pointer"
          >
            <HiOutlineOfficeBuilding className="w-7 h-7 group-hover:scale-110 transition-transform" />
