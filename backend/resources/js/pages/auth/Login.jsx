...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const pwdErr = responseData?.errors?.password?.[0] || responseData?.errors?.email?.[0];
      if (pwdErr) {
      ...
      >
        <div className="glass-strong rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              <label className="block text-sm font-medium text-dark-300 mb-1.5">Email Address or Mobile Number</label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@college.com or 9876543210"
            ...
            >
              ...
              {passwordError && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="mt-3 p-3 bg-red-950/20 border border-red-900/30 rounded-xl flex flex-col gap-1.5"
                >
                  <p className="text-xs text-red-400 font-medium leading-normal">{passwordError}</p>
                  <Link 
                    to="/forgot-password" 
                    className="text-xs text-primary-400 hover:text-primary-300 font-bold underline self-start transition-colors"
                  >
